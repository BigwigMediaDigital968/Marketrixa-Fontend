        ...
        <div className="container mx-auto px-6 md:px-30 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              ...
              >
                Scale Your Visibility with the{" "}
                <span className="italic font-light text-transparent bg-clip-text bg-gradient-to-r from-[#F26522] via-orange-400 to-white pe-2">
                  Best SEO Services
                </span>{" "}
                in Ahmedabad
              </motion.h1>
              ...
              >
                As a trusted search engine optimization company in Ahmedabad, we
                use advanced analytics and data-driven strategies to push your
                website to the top of Google. Get SEO that goes beyond rankings
                and actually delivers business growth.
              </motion.p>
              ...
              >
                <Link
                  href="/contact"
                  className="relative group overflow-hidden bg-[#F26522] text-white px-8 py-4 rounded-xl font-bold flex items-center space-x-3 transition-all active:scale-95 shadow-[0_10px_30px_-10px_rgba(242,101,34,0.5)]"
                >
                ...
                <button
                  ...
                  className="group flex items-center space-x-4 px-8 py-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl transition-all text-white font-medium backdrop-blur-sm cursor-pointer"
                >
