                ...
                >
                  ...
                  <div className="pt-4 flex gap-6">
                    <button
                      ...
                      className="group cursor-pointer relative inline-flex items-center justify-center px-8 py-4 bg-[#F26522] text-black font-black uppercase tracking-tighter text-sm rounded-full overflow-hidden transition-all duration-300 hover:pr-12 active:scale-95"
                    >
                      {/* Hover overlay */}
                    ...
                    <Link href="/portfolio"
                      className="group cursor-pointer relative inline-flex items-center justify-center px-8 py-4 border border-[#F26522] text-white font-black uppercase tracking-tighter text-sm rounded-full overflow-hidden transition-all duration-300 hover:border-[#F26522] hover:text-black active:scale-95"
                    >
                      <span className="absolute inset-0 bg-[#F26522] translate-y-full group-hover:translate-y-0 transition-transform duration-300 z-0" />
