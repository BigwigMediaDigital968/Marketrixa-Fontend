...
const services: ServiceItem[] = [
  {
    ...
    fullDesc: "We build and scale conversion-focused Meta ad campaigns with data-backed creatives, audience testing, retargeting systems, and aggressive ROAS optimization strategies.",
    icon: Smartphone,
    videoUrl: "https://cdn.pixabay.com/video/2020/05/23/39892-423345743_large.mp4",
    fallbackImage: "/home/MetaAds.png",
    status: "META CAMPAIGNS: SCALING",
    color: "from-[#1877F2]/20 via-[#1877F2]/5 to-transparent",
    caseStudy: {
      problem: "Client acquisition costs increased due to poor audience targeting.",
      strategy: "Launched multi-angle creative testing with advanced retargeting flows.",
  ...
  },
  {
    ...
    fullDesc: "Capture high-intent buyers through optimized Google Search, Display, YouTube, and Performance Max campaigns engineered for scalable growth.",
    icon: Bot,
    ...
    caseStudy: {
      ...
      strategy: "Rebuilt keyword targeting, landing pages, and conversion tracking.",
  ...
  },
  {
    ...
    fullDesc: "Produce scroll-stopping UGC videos designed for paid ads, social proof, and conversion performance across Meta, TikTok, and Reels ecosystems.",
    icon: MessageSquare,
    fallbackImage: "/home/ugcvideo.png",
    videoUrl: "https://cdn.pixabay.com/video/2020/02/16/32454-392669561_large.mp4",
    status: "UGC CONTENT: LIVE",
    color: "from-emerald-500/20 via-emerald-500/5 to-transparent",
    caseStudy: {
      problem: "Traditional ad creatives suffered from banner blindness and fatigue.",
      strategy: "Produced creator-led native style UGC hooks with rapid testing cycles.",
  ...
  },
  {
    ...
    fullDesc: "Scale brand awareness and trust through influencer campaigns, creator partnerships, whitelisting collaborations, and performance-driven social activations.",
    icon: Database,
    fallbackImage: "/home/video.png",
    videoUrl: "https://cdn.pixabay.com/video/2019/04/05/22599-328624855_large.mp4",
    ...
    caseStudy: {
      ...
      strategy: "Activated niche creators with performance-based influencer campaigns.",
      result: "Reached 12M+ targeted users and increased branded search by 210%.",
  ...
  return (
    <div className=" text-white font-sans antialiased min-h-screen flex flex-col justify-center relative overflow-hidden py-16">
      ...
      <div 
        ...
        style={{
          background: "radial-gradient(circle at 10% 20%, rgba(242,101,34,0.05) 0%, transparent 60%), radial-gradient(circle at 90% 80%, rgba(242,101,34,0.03) 0%, transparent 60%)"
        }}
      />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 w-full">
        ...
        <div className="mb-12">
          ...
          >
            ...
            <span className="text-[10px] font-mono text-[#f26522] uppercase tracking-[0.3em] font-black">Core Capabilities</span>
          </motion.div>
          ...
          >
            ...
            <span className="text-[#f26522] italic font-light">Top Services?</span>
          </motion.h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 flex flex-col gap-3 mt-20">
            {services.map((srv) => {
                ...
                >
                  ...
                  <div className="flex items-center gap-4 relative z-10">
                    ...
                    <div className="text-left min-w-0">
                      <h3 className={`text-lg font-black tracking-tight pt-0.5 leading-none ${
            ...
            <div className="relative z-10 space-y-5 h-full flex flex-col justify-between">
              ...
              <div className="relative aspect-[16/9] w-full rounded-2xl overflow-hidden bg-neutral-950 border border-white/10 shadow-2xl group/player">
                ...
                <div className="h-6 w-full bg-neutral-900 border-b border-white/5 flex items-center justify-between px-3 z-10 relative">
                  ...
                  <span className="text-[7.5px] font-mono tracking-widest text-white/30 uppercase">audited_telemetry_loop.mp4</span>
                  <div className="w-10" />
                </div>

                {/* Video Render viewport */}
                <div className="relative w-full h-[calc(100%-24px)] overflow-hidden">
                  <img src={activeTab.fallbackImage} alt={activeTab.title} className="absolute inset-0 w-full h-full object-cover opacity-100"/>
                  ...
                  <div className="absolute top-3 left-3 flex items-center gap-1.5 bg-black/60 border border-[#f26522]/20 px-2.5 py-1 rounded-lg backdrop-blur-sm shadow-xl pointer-events-none">
                    ...
                    <span className="text-[7.5px] font-mono text-white/70 uppercase tracking-widest font-black">{activeTab.status}</span>
                  </div>
