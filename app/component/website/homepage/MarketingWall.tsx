...
const influencers: InfluencerItem[] = [
  {
    id: 1,
    name: "Mukul Sharma",
    handle: "@iammukulsharmaa",
    niche: "Technology & Gadgets",
    followers: "380K+ Followers",
    imageUrl: "/influencer/mukul.jpg",
    socialUrl: "https://www.instagram.com/iammukulsharmaa",
    campaignResults: {
      metric: "6.4x ROI Lift",
      subMetric: "14K Qualified Leads",
      description:
        "Tech-focused campaigns driving high engagement and conversion rates.",
    },
...

  {
    id: 2,
    name: "Niladri Kumar",
    handle: "@niladri_kumar",
    niche: "Music & Entertainment",
    followers: "Instagram Creator",
    imageUrl: "/influencer/niladri-kumar.avif",
    socialUrl: "https://www.instagram.com/niladri_kumar",
    campaignResults: {
      metric: "8.1M Reach",
      subMetric: "1.2M Video Views",
      description:
        "Strong audience engagement through music and live performance content.",
    },
    channelIcon: FaInstagram,
  },
  ...
  //     id: 3,
  //     name: "Nawab",
  //     handle: "@ursnawabofficial_",
  //     niche: "Lifestyle & Entertainment",
  //     followers: "Instagram Creator",
  //     imageUrl: "/influencer/nawab.jpg",
  //     socialUrl: "https://www.instagram.com/ursnawabofficial_",
  //     campaignResults: {
  //       metric: "5.3x ROAS",
  //       subMetric: "850K Campaign Reach",
  //       description:
  //         "High-performing lifestyle collaborations with strong audience trust.",
  //     },
  //     channelIcon: FaInstagram,
  //   },

  {
    ...
    handle: "@hindustanibhaukingsarkar",
    niche: "Public Figure & Entertainment",
    followers: "Verified Creator",
    imageUrl: "/influencer/hindustani-bhau.webp",
    socialUrl: "https://www.instagram.com/hindustanibhaukingsarkar",
    campaignResults: {
      metric: "12M+ Reach",
      subMetric: "Mass Audience Visibility",
      description:
        "Large-scale awareness campaigns with broad audience penetration.",
    },
    channelIcon: FaInstagram,
  },

  {
    ...
    name: "Sudaksh DJ",
    handle: "@sudaksh_dj",
    niche: "DJ & Music Events",
    followers: "Instagram Creator",
    imageUrl: "/influencer/sudaksh.jpg",
    socialUrl: "https://www.instagram.com/sudaksh_dj/",
    campaignResults: {
      metric: "3.8M Event Reach",
      subMetric: "120K Engagements",
      description:
        "Music and nightlife promotions with highly engaged audiences.",
    },
    channelIcon: FaInstagram,
  },

  {
    ...
    followers: "Instagram Creator",
    imageUrl: "/influencer/samira.jpg",
    socialUrl: "https://www.instagram.com/kazi.samira",
    campaignResults: {
      metric: "7.2x Engagement",
      subMetric: "650K Organic Reach",
      description:
        "Premium fashion and lifestyle campaigns with strong audience affinity.",
    },
    channelIcon: FaInstagram,
  },
];
  ...
  return (
    <div className="bg-neutral-950 text-white font-sans antialiased overflow-hidden py-16 md:py-24 relative w-full flex flex-col justify-center min-h-screen">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 50% 50%, rgba(242,101,34,0.04) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-12">
          ...
          <p className="text-neutral-400 text-xs md:text-sm leading-relaxed max-w-md">
            We deploy verified whitelisted dark posts directly from custom
            creator channels. Hover over any influencer card to stop the slider
            and inspect verified ad returns.
          </p>
        </div>
        ...
        >
          ...
          <div
            className={`animate-marquee-infinite ${
              isMarqueePaused ? "marquee-paused-state" : ""
            } flex gap-5`}
          >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="text-sm font-bold text-white">
                Want verified creators advocating your product Swaps?
              </h4>
              <p className="text-[10px] text-neutral-400">
                Schedule an onboarding strategy audit with our direct-response
                team.
              </p>
            </div>
          </div>
