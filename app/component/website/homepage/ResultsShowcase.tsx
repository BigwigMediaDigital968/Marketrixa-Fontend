...
const resultsData: ResultItem[] = [
  {
    ...
    accentColor: "#f26522",
    description:
      "Multi-channel scaling campaign optimized via predictive lookalikes and customized landing pages.",
  },
  {
    id: 2,
    ...
    accentColor: "#f26522",
    description:
      "High-intent lead generation capturing premium B2B decision makers.",
  },
  {
    id: 3,
    ...
    accentColor: "#f26522",
    description:
      "Hyper-focused keyword restructuring and intelligent bidding rules optimization.",
  },
  {
    id: 9,
    ...
    gridClass: "md:col-span-1",
    screenshotUrl:
      "https://images.unsplash.com/photo-1625296276703-3fbc924f07b5?q=80&w=1170&auto=format&fit=crop",
    accentColor: "#f26522",
    description:
      "Landing page layout tuning and psychological checkout triggers integration.",
  },
  {
    id: 4,
    label: "Campaign Conversion Peak",
  ...
  },
  {
    ...
    gridClass: "md:col-span-2",
    screenshotUrl:
      "https://images.unsplash.com/photo-1560472354-b33ff0c44a43?q=80&w=1251&auto=format&fit=crop",
    accentColor: "#f26522",
    description:
      "Omnichannel brand dominance targeting warm prospective custom segments.",
  },
  {
    id: 6,
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-10">
            <div className="max-w-xl">
              ...
              <p className="mt-2 text-neutral-400 text-xs md:text-sm max-w-md leading-relaxed">
                We design and scale high-intensity campaigns that maximize ROI
                and consistently crush client KPIs. Hover cards to reveal
                strategy logs.
              </p>
            </div>
            ...
            >
              {[
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg cursor-pointer text-[10px] font-semibold tracking-wider uppercase transition-all duration-300 relative ${
  ...
  "
                  ...
                  <div className="relative p-5 z-10 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-1.5 bg-neutral-900/90 border border-white/5 pl-2 pr-2.5 py-1 rounded-full backdrop-blur-sm">
                      ...
                      <span className="text-[8px] font-mono tracking-wider text-white/50 uppercase">
                        AUDITED
                      </span>
                    </div>
                  </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-sm font-bold">
                  Ready to see these numbers on your campaigns?
                </h4>
                <p className="text-[11px] text-neutral-400">
                  Book a strategy session with our lead growth advisors.
                </p>
              </div>
            </div>
