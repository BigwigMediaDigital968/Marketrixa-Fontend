    ...
    return (
        <div className=" text-white font-sans antialiased overflow-hidden py-10 mt-10 relative w-full">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
                ...
                <div className="w-full rounded-[2rem] bg-gradient-to-b from-[#140a04]/40 to-[#050201]/60 border border-[#f26522]/20 p-6 md:p-8 shadow-2xl relative">
