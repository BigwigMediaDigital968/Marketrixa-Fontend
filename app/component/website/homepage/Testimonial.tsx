...
export default function Testimonials() {
  ...
  return (
    <>
      <div className="max-w-7xl mt-24 pb-12 flex flex-col justify-center items-center mx-auto w-full">
        <span className="text-[#F26522] uppercase tracking-[0.3em] text-xs font-bold mb-5">
          WHAT OUR CLIENTS SAY
        </span>
        <h2 className="text-3xl md:text-5xl font-black text-white leading-tight tracking-wider">
          Real Brands. Real Results.{" "}
          <span className="text-[#F26522]">Real Growth.</span>
        </h2>
      </div>
