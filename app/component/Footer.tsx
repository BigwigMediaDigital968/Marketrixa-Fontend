        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-24 pb-24 border-b border-white/5">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              ...
              <button className="px-8 py-4 rounded-full border border-white/10 text-white hover:bg-white hover:text-black transition-all font-semibold cursor-pointer">
                Contact Sales
              </button>
            </div>
          </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-20">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="flex items-center gap-2">
              <svg viewBox="0 0 100 100" className="w-8 h-8 fill-[#F26522]">
              ...
              <ul className="space-y-4">
                {column.links.map((link, lIdx) => (
                  <li key={lIdx}>
                    <a
                      href="#"
                      className="text-gray-500 hover:text-[#F26522] transition-colors text-sm font-medium"
                    >
                      {link}
                    </a>
                  </li>
